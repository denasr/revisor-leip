...
const CHECKLIST = [
  ...
  { id: 3,  seccion: "CRITERIOS EDITORIALES",       criterio: "Todo el texto justificado, incluyendo referencias, excepto en portada, portadilla y en Títulos Nivel 1 " },
  ...
  { id: 9,  seccion: "PORTADA Y PORTADILLA",        criterio: "Fecha en minúsculas al final de ambas páginas incluyendo el mes a excepción de la letra inicial de las otras dos palabras " },
  ...
  { id: 42, seccion: "ACCESORIOS — PÁRRAFOS",       criterio: "Sangría en el primer renglón de cada párrafo de 1.27 cm (excepto en los párrafos de títulos nivel 4)" },
  ...
  { id: 44, seccion: "ACCESORIOS — TABLAS Y FIGURAS", criterio: "Número de tabla/figura en negrita (esquina superior izquierda, sin punto); título en cursiva (Letra Capital) en el renglón siguiente, a excepción de las estrategiaslas" },
  ...
  { id: 46, seccion: "ACCESORIOS — TABLAS Y FIGURAS", criterio: "Diseño de tablas preferentemente sin líneas verticales excepto en las estrategias donde las tablas si llevan líneas verticales y horizontales" },
  ...
  { id: 49, seccion: "ACCESORIOS — TÍTULOS",        criterio: "Nivel 3: Izquierda, Negrita Cursiva, Letra Capital, numeración 1.1.1. Nivel 4: Sangría, Negrita, Letra Capital, punto final. Nivel 5: Sangría, Negrita Cursiva, punto final. No verificar el Nivel 5 si no está presente" },
  { id: 50, seccion: "CITAS APA 7ª — EN TEXTO",     criterio: "Citas textuales <40 palabras: narrativas (Autor dentro del texto, año entre paréntesis, 'cita', página entre paréntesis) y parentéticas ('cita', Autor, año, y página al final de la cita entre paréntesis) correctamente aplicadas" },
  ...
  { id: 52, seccion: "CITAS APA 7ª — EN TEXTO",     criterio: "Paráfrasis narrativas y parentéticas: en citas narrativas el Autor va dentro del texto, año entre paréntesis, se integran correctamente; en citas parentéticas solo el primer apellido del autor y página, ambos entre paréntesis" },
];
