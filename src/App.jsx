...
const CHECKLIST = [
  ...
  { id: 9,  seccion: "PORTADA Y PORTADILLA",        criterio: "Fecha en minúsculas al final de ambas páginas incluyendo el mes a exepción de la primera letra del lugar la cual va en mayúsculas" },
